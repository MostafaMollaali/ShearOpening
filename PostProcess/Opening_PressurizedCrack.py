...
shear_pf_pcs_1pvd = PVDReader(FileName='/Users/mollaali/Opening/PhaseField/tensile/half_h0p00125/results/tensile_pf.pvd')
...
output = open('/Users/mollaali/Opening/PhaseField/tensile/half_h0p00125/results/Pressureopening_half.csv','w+')
